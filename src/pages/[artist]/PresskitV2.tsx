...
import { Bio, Content, Cover2, Player, Presskit, Release, Social, SocialButton, Title, Wrapper } from "styles/styles";
import { InstagramEmbed } from 'react-social-media-embed';

const PresskitV2: FC<{ artist: IArtist, slug: string }> = ({ artist, slug }) => {
