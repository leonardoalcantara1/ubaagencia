...
const artists: IArtists = {
  emize: {
    ...
    soundcloud: 'leoemize',
    instagram: 'leo.emize',
    title: 'EMIZÊ - Projeto de Progressive trance e HardProg :: Ubá Coletivo',
    description:
      'Emizê é o projeto de progressive trance e hardprog de Leonardo Martinez, DJ e produtor musical fundador do coletivo de artistas da UBÁ.',
  },
  comicbass: {
